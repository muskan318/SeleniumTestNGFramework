...
public class baseClass {
	...
	// to generate unique mail id everytime during registration and static so that
	// same variable copy is shared in other classes
	public static String emailId = generateRandoEmailID();

	// declaring global so that can be used throughout the class
	...
	private static String generateRandoEmailID() {
